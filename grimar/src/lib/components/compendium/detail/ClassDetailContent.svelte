...
{#if spellcasting}
	<div class="mb-8 rounded-xl border border-blue-500/20 bg-blue-500/5 p-4">
		...
		<div class="text-sm text-gray-300">
			Uses <span class="font-bold text-white">{(spellcasting.ability as any)?.name}</span> as spellcasting
			ability. DC <span class="font-bold text-white">{spellcasting.dc}</span>, Modifier
