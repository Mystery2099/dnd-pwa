...
<div class="flex min-h-[60vh] items-center justify-center">
	<div class="w-full max-w-md">
		...
		>
			...
			<!-- Title -->
			<h1 class="mb-2 text-2xl font-bold text-[var(--color-text-primary)]">Sign In to Grimar</h1>
			...
			<div class="flex flex-col gap-3">
				...
				<a
					href="/"
					class="rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-card)] px-6 py-3 font-medium text-[var(--color-text-primary)] transition-all hover:bg-[var(--color-bg-overlay)]"
				>
					Go to Homepage
				</a>
			</div>
